...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={fullpage} alt="Full page view of cheatsheet" class="zoom-image" data-zoom-src="/blog/2024-04-24-how-to-put-20k+-words-on-a-cheatsheet/01-fullpage.jpg"/>
    <figcaption>Full page view of cheatsheet</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={zoomed} alt="Zoomed in view of cheatsheet" class="zoom-image" data-zoom-src="/blog/2024-04-24-how-to-put-20k+-words-on-a-cheatsheet/01-zoomed.jpg" />
