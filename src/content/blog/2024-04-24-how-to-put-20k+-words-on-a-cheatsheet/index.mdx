...
tags: ['tutorial', 'university', 'code', 'python', 'typst']
image: './00-thumbnail.png'
authors: ['sadman']
thumbnailIcon: 'lucide:file-text'
thumbnailIconSize: 'h-10 w-10'
thumbnailIconColor: 'oklch(0.48 0.2 288)'
thumbnailBgColor: 'oklch(0.82 0.1 296)'
thumbnailIconColorDark: 'oklch(0.82 0.1 296)'
thumbnailBgColorDark: 'oklch(0.48 0.2 288)'
---
