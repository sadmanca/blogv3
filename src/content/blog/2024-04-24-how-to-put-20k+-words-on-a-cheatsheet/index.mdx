...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={fullpage} alt="Full page view of cheatsheet" class="zoom-image" data-zoom-src="/blog/2024-04-24-how-to-put-20k+-words-on-a-cheatsheet/01-fullpage.webp"/>
...
<div class="relative">
  ...
  <figure class="absolute z-1 -top-8 -right-[280px] w-[260px] max-w-[40vw] md:block hidden">
    <Image src={ece241} alt="My cheatsheet for an introductory digital logics course" data-zoom-src="/blog/2024-04-24-how-to-put-20k+-words-on-a-cheatsheet/03-ece241.webp" class="zoom-image" />
