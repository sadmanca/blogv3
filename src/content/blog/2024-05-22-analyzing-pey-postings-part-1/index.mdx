...
<div class="flex text-center flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={peyLoginImage} alt="The PEY job board login portal" class="zoom-image" />
    <figcaption>The PEY job board login portal at [uoftengcareerportal.ca/notLoggedIn](https://www.uoftengcareerportal.ca/notLoggedIn)</figcaption>
  </figure>
</div>
