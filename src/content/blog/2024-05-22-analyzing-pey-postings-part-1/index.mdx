...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={a2} alt="The PEY Co-op job board landing page (Job Postings)" class="zoom-image" data-zoom-src="/blog/2024-05-22-analyzing-pey-postings-part-1/01-pey-landing-page.webp" />
...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={viewedjobs} alt="Viewed jobs (Viewed)" class="zoom-image" data-zoom-src="/blog/2024-05-22-analyzing-pey-postings-part-1/01-pey-viewed.webp" />
...
<div class="flex flex-col md:flex-row gap-4 my-6">
  ...
  <figure class="flex-1 m-0">
    <Image src={a5} alt="Current design for PEY job postings. One of the most recent jobs posted at the time of writing. Shown: Software Developer Intern @ Geotab" class="zoom-image" data-zoom-src="/blog/2024-05-22-analyzing-pey-postings-part-1/02-pey-sample-posting.webp" />
...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={isitworth} alt="xkcd: 'Is It Worth the Time?'" class="zoom-image" data-zoom-src="/blog/2024-05-22-analyzing-pey-postings-part-1/is_it_worth_the_time.webp" />
    <figcaption>xkcd: ['Is It Worth the Time?'](https://xkcd.com/1205/)</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={automation} alt="xkcd: 'Automation'" class="zoom-image" data-zoom-src="/blog/2024-05-22-analyzing-pey-postings-part-1/automation.webp" />
