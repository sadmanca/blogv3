...
<figure>
  <Image src={trellokanban} alt="A kanban board with cards in Trello"  class="zoom-image wide-img"  />
...
<figure>
  <Image src={withincards} alt="Trello card options including description, due date, checklists, labels, and more" class="zoom-image wide-img"  />
...
<figure>
  <Image src={howIUseIt} alt="Example of using Trello to organize schoolwork, side projects, and extracurricular activities" class="zoom-image wide-img"  />
...
<figure>
  <Image src={powerups} alt="Examples of Trello Power-Ups including calendar integration, due date countdowns, and cloud service integrations" class="zoom-image wide-img"  />
