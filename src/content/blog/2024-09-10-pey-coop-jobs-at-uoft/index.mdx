...
tags: ['UofT', 'university', 'code', 'python', 'work', 'intern']
...
<Callout type="info" classes="border-blue-950/100 bg-blue-100 dark:border-blue-100/100 dark:bg-blue-950 wide-img">
  <div class="-mt-4">
    Check out **<a href={`${SITE.href}/uoft-pey-coop-jobs-2023.html`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-pey-coop-jobs-2023</a>** to view all jobs posted for the 12-16 month University of Toronto PEY Co-op program from September 2023 to June 2024.
  </div>
</Callout>
...
...then check out **<a href={`${SITE.href}/uoft-pey-coop-jobs-2023.html`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-pey-coop-jobs-2023</a>**.
...
<Callout type="info" classes="border-blue-950/100 bg-blue-100 dark:border-blue-100/100 dark:bg-blue-950">
  That's why I built a dashboard of all the jobs that were posted while I had access to the PEY portal at **<a href={`${SITE.href}/uoft-pey-coop-jobs-2023.html`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-pey-coop-jobs-2023</a>**.
</Callout>
