...
tags: ['tutorial', 'tools', 'cli', 'terminal', 'code']
authors: ['sadman']
thumbnailIcon: 'lucide:square-dashed-bottom-code'
thumbnailIconSize: 'h-10 w-10'
thumbnailIconColor: 'oklch(0.8 0 0)'
thumbnailBgColor: 'oklch(0.45 0 0)'
thumbnailIconColorDark: 'oklch(0.45 0 0)'
thumbnailBgColorDark: 'oklch(0.8 0 0)'
---
