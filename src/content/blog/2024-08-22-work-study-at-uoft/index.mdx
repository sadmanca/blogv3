...
<Callout type="info" classes="border-blue-950/100 bg-blue-100 dark:border-blue-100/100 dark:bg-blue-950 -mb-4 wide-img">
  **There’s an easier way to view work study jobs for the 2024 academic year** and you can check it out at **<a href={`${SITE.href}/uoft-work-study-2024`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-work-study-2024</a>**!
</Callout>
...
<Callout type="info" icon="lucide:star" classes="border-yellow-950/100 bg-yellow-100 dark:border-yellow-100/100 dark:bg-yellow-950">
  You can also **view work study job postings for 2025 summer** at **<a href={`${SITE.href}/uoft-work-study-2025-summer`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-work-study-2025-summer</a>**.
</Callout>
...
<Callout type="info" classes="border-blue-950/100 bg-blue-100 dark:border-blue-100/100 dark:bg-blue-950 wide-img">
  **The dashboard is live and you can view it at <a href={`${SITE.href}/uoft-work-study-2024`} target="_blank" rel="noopener noreferrer">sadman.ca/uoft-work-study-2024</a>**.
</Callout>
