...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={d1} alt="Redesigned UofT work study job postings dashboard" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/04-new-work-study-job-dashboard.webp" />
...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={landing} alt="CLNx landing page before login" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/02-clnx-landing-page.webp" />
    <figcaption>CLNx landing page before login</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={home} alt="CLNx home page after user login" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/02-clnx-actual-home-page.webp" />
...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={i1} alt="CLNx job board landing page with search options" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/03-clnx-home-page.webp" />
    <figcaption>CLNx job board landing page with search options</figcaption>
  </figure>

  <figure class="flex-1 m-0">
    <Image src={i2} alt="CLNx job listings page showing various job postings" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/03-clnx-job-page.webp" />
...
<div class="wide-img flex flex-col md:flex-row gap-4 my-6">
  <figure class="flex-1 m-0">
    <Image src={job_description_page} alt="What a job description page looks like on CLNx" class="zoom-image" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/03-example-job.webp" />
...
<figure>
  <Image src={d1} alt="Redesigned UofT work study job postings dashboard" class="zoom-image wide-img" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/04-new-work-study-job-dashboard.webp" />
...
<figure>
  <Image src={d2} alt="Zoomed-in view of redesigned UofT work study job postings dashboard" class="zoom-image wide-img" data-zoom-src="/blog/2024-08-22-work-study-at-uoft/04-zoom-in.webp" />
