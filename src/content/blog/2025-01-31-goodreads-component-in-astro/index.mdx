...
tags: ['tutorial', 'code', 'books', 'webdev']
image: './00-thumbnail.png'
authors: ['sadman']
thumbnailIcon: 'simple-icons:goodreads'
...
import sadmanRss from './sadman-rss-sample.xml?raw';
...
Of course, Goodreads RSS feeds use no stylesheets whatsoever, so parsing through the unformatted text is unwieldy.
  ...
  <figure class="flex-1 m-0">
    <Image src="/blog/2025-01-31-goodreads-component-in-astro/rss-in-browser-full.webp" alt="Goodreads RSS Feed formatting in FireFox" class="zoom-image" width={1200} height={744} />
...
<Code code={sadmanRss} lang="xml" title="rss.xml" collapse="1-20" mark={mark} wrap={false} />
