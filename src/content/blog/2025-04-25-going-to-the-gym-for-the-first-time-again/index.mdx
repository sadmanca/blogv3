...
<div class="flex flex-col md:flex-row items-start gap-6 my-6">
  <div class="flex-1">
    <p>
  ...
  <figure class="flex-1 flex flex-col items-center">
    ...
    <figcaption class="text-center text-sm text-gray-500 mt-2">
      A screenshot from today's workout tracked in <a href="https://hevy.com">Hevy</a>
    </figcaption>
  </figure>
</div>
...
<figure>
  <Image src={gymPhoto} alt="A photo of me at the gym on my first day back." class="zoom-image" data-zoom-src="/blog/2025-04-25-going-to-the-gym-for-the-first-time-again/images/2025-04-25-first-day-back-at-the-gym.jpg" />
